      ...
      <div class="row">
          ...
          <div class="row mb-5">
            ...
            @if (isset(Auth::user()->id))
              <form action="{{ route('save.job') }}" method="POST">
                ...
                @if($savedJob)
                  <button  class="btn btn-block btn-success btn-md" >You saved this Job</button>
                @else
        ...
        <div class="col-lg-4">
          ...
          <div class="bg-light p-3 border rounded">
            <h3 class="text-primary  mt-5 h5 pl-3 mb-3 ">Share</h3>
            <div class="px-3">
          ...
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><a class="text-decoration-none" href="{{ route('category.single',$category->name) }}">{{ $category->name }}</a> </li>
    ...
    <div class="container">
      ...
      <div class="row mb-5 justify-content-center">
        <div class="col-md-7 text-center">
          <h2 class="section-title mb-2">{{ $relatedCount }} Related Jobs</h2>
        </div>
      </div>
